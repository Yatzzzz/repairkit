...
function loadAnimDict(dict)
    ...
    while not yatzzzimDictLoaded(dict) do
        Citizen.Wait(5)
    end
end

RegisterNetEvent("yatzzz:tamiret")
AddEventHandler("yatzzz:tamiret",function()
        ...
        if #cars == 0 then
            ...
            if bits ~= 100 then
                ...
                if bits2 ~= 100 then
                    ...
                    exports["np-taskbar"]:taskBar(8500, "Tamir Ediliyor! ")
                    TriggerServerEvent("removeitem","fixtool")
